...
config.colors = {
  ...
  foreground = '#e6edf3',   -- The default text color
  background = '#0d1117',   -- The default background color

  cursor_bg = '#2f81f7',   -- Overrides the cell background color when the current cell is occupied by the cursor and the cursor style is set to Block
  cursor_fg = '#6fc1ff',   -- Overrides the text color when the current cell is occupied by the cursor
  cursor_border = '#2f81f7',   -- Specifies the border color of the cursor when the cursor style is set to Block, or the color of the vertical or horizontal bar when the cursor style is set to Bar or Underline.

  selection_fg = '#0d1117',   -- the foreground color of selected text
  selection_bg = '#e6edf3',   -- the background color of selected text
  ...
  ansi = {
    '#2f3742', -- 'black' base-color-neutral-1
    ...
    '#f0f6fc', -- 'silver' base-color-neutral-9
  },
  brights = {
    '#656c76', -- 'grey' base-color-neutral-4
    ...
    '#ffffff', -- 'white' base-color-neutral-12
  },
